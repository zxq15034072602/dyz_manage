...
if($do == "uerinfo"){//用户中心个人信息
    ...
    $sql="SELECT * FROM rv_user where username =? and type=? LIMIT 1";//判断用户是否存在
    $db->p_e($sql,array($mobile,$user_type));
    ...
    if($reg_uid){ 
        echo '{"code":"200","msg":"注册成功","uid":"'.$reg_uid.'"}';exit;
    }
    echo '{"code":"500","msg":"注册失败"}';exit;
}
